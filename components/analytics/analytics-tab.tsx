          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={customerSegmentationData}>
                ...
                <YAxis />
                <Tooltip />
                <Bar dataKey="count" fill={theme === "dark" ? "#f0f0f0" : "#0ea5e9"} />
              </BarChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              <LineChart data={retentionRateData}>
                ...
                <YAxis />
                <Tooltip />
                <Line type="monotone" dataKey="rate" stroke={theme === "dark" ? "#f0f0f0" : "#0ea5e9"} />
              </LineChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={channelPerformanceData}>
                ...
                <Tooltip />
                <Bar yAxisId="left" dataKey="acquisitions" fill={theme === "dark" ? "#f0f0f0" : "#0ea5e9"} />
                <Bar yAxisId="right" dataKey="revenue" fill={theme === "dark" ? "#a0a0a0" : "#3b82f6"} />
              </BarChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
